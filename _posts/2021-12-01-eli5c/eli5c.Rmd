...
Therefore, we built our abridged but categorized version of the ELI5 dataset using posts in the subreddit from 2017 to 2021, which named as [ELI5_Category](https://huggingface.co/datasets/eli5_category). Our dataset contains more than **100,000 questions and 220,000 answers**.
...
> - [eli5_category📚](https://huggingface.co/datasets/eli5_category)
